...
logging.basicConfig(level=logging.INFO, format='[Instagram Mock] %(message)s')
logger = logging.getLogger("ConnectorInsta")

app = FastAPI(title="Instagram Connector Mock")

# Tópico diferente
TOPIC_OUTBOX = os.getenv("KAFKA_TOPIC_INSTA", "instagram_outbox") 
TOPIC_INBOX = os.getenv("KAFKA_TOPIC_MESSAGES", "messages")
